...
<template>
  <div>
    <QualityInspectionListSearch ref="QualityInspectionListSearch">
    </QualityInspectionListSearch>
    <QualityInspectionListTable ref="QualityInspectionListTable" :tableData="tableData" :tableLoading="tableLoading">
    </QualityInspectionListTable>
...
import QualityInspectionListSearch from "@/components/warehouse/qualityInspectionList/QualityInspectionListSearch";
import QualityInspectionListTable from "@/components/warehouse/qualityInspectionList/QualityInspectionListTable";
import authorButtons from "@/compositionApi/authorButtons";
import { backTableTop } from "@/utils/util";
export default {
  name: "qualityInspectionList",
  components: { QualityInspectionListSearch, QualityInspectionListTable },
  setup(prop, ctx) {
    ...
    onActivated(() => {
      // getTableData();
      setTimeout(() => {
        backTableTop("#QualityInspectionListTable", data.scroll);
      }, 100);
      window.addEventListener("scroll", handleScroll, true);
    });
    onDeactivated(() => {
    ...
    const handleScroll = () => {
      data.scroll = document.querySelector(
        `#QualityInspectionListTable .el-table .el-table__body-wrapper`
      ).scrollTop;
    };
