<!-- 直发盘点单审核 StraightAudit-->
<template>
    <div id='StraightAudit'>
        <el-dialog :title="data.title" width="90%" v-model="data.addVisible" :close-on-click-modal="false"
            ...
            <el-form ref="ruleRef" label-width="80px" :inline="true" :model="data.searchForm" :rules="data.rules"
                ...
                <el-form-item label="库位:" prop="location">
                    <el-input placeholder="双击批量查询" v-model="data.searchForm.location"
                        @dblclick="openInput(data.searchForm.location, 'location')" clearable></el-input>
                </el-form-item>
